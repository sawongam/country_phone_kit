...
| Card | Shows |
| --- | --- |
| **Just the data** | `Countries.all`, `byIsoCode`, `byDialCode`, `primaryForDialCode`, `Currencies`, and the one-line `PhoneNumber.isValidNumber` / `formatE164` — no widget from this package on screen |
